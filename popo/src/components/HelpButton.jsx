...
import { HelpCircle, X, ChevronDown, ChevronUp, BookOpen, User, Building, Eye, Search } from 'lucide-react';
        ...
        <>
          ...
          >
            ...
            <div className="help-popup-content">
              {/* Search Bar */}
              <div className="help-popup-search-container">
                <div className="help-popup-search-wrapper">
                  <div className="help-popup-search-input-wrapper">
                    <Search className="help-popup-search-icon" size={16} />
                    <input
                      type="text"
                  ...
                  {searchQuery && (
                    <button
                      onClick={clearSearch}
                      className="help-popup-search-clear-btn"
                      title="Clear search"
                    >
                      <X size={16} />
                    </button>
                ...
                {searchQuery && (
                  <div className="help-popup-search-results-count">
              ...
              {/* Role Selection */}
              <div className="help-popup-role-selector">
                <button
                  className={`role-popup-btn ${selectedRole === 'administrator' ? 'active' : ''}`}
                ...
                <button
                  className={`role-popup-btn ${selectedRole === 'municipality' ? 'active' : ''}`}
              ...
              {/* Steps List */}
              <div className="help-popup-steps">
                <h3 className="help-popup-steps-title">
                  {selectedRole === 'administrator' ? 'Administrator Guide' : 'Municipality Guide'}
                </h3>
                
                {filteredContent.length > 0 ? (
                  <div className="steps-popup-list">
                    {filteredContent.map((item) => (
                      <div key={item.step} className="help-popup-step">
                        <div 
                          className="step-popup-header"
                          onClick={() => toggleStep(item.step)}
                        >
                          <div className="step-popup-number">
                            {item.step}
                          </div>
                          <div className="step-popup-title">
                            {item.title}
                          </div>
                          <div className="step-popup-toggle">
                        ...
                        {expandedSteps[item.step] && (
                          <div className="step-popup-content">
                            <div className="step-popup-description">
                              {item.content}
                            </div>
                            <div className="step-popup-media">
                              <div className="media-popup-placeholder">
                                <Eye size={24} />
                  ...
                  <div className="help-popup-no-results">
                    <Search size={40} className="popup-no-results-icon" />
